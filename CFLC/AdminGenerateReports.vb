...
Public Class AdminGenerateReports
    ...
    Private Sub cmbEnrollmentView_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbEnrollmentView.SelectedIndexChanged
        ' Only load enrollment if not initializing and an item is selected
    ...
    Private Sub LoadSubjectsByGrade()
        Try
            ...
            ' Check if "All Subjects" is selected
            ...
            Else
                ...
                ' Query subjects filtered by grade level
                Dim sql As String = "SELECT SubjectID, SubjectCode, SubjectName, Category, GradeLevel, Status " &
                                    "FROM subject " &
    ...
    Private Sub btnAdminGenerateStudents_Click(sender As Object, e As EventArgs) Handles btnAdminGenerateStudents.Click
        ' Check if grade is selected
        If cmbGradeLevel.SelectedItem Is Nothing Then
    ...
    Private Sub btnAdminGenerateEnrollmentSummary_Click(sender As Object, e As EventArgs) Handles btnAdminGenerateEnrollmentSummary.Click
        ' Check if grade is selected
        If cmbEnrollmentView.SelectedItem Is Nothing Then
    ...
    Private Sub btnAdminGenerateSections_Click(sender As Object, e As EventArgs) Handles btnAdminGenerateSections.Click
        ' Check if grade is selected
        If cmbSectionView.SelectedItem Is Nothing Then
    ...
    Private Sub btnAdminGenerateSubjects_Click(sender As Object, e As EventArgs) Handles btnAdminGenerateSubjects.Click
        ' Check if grade is selected
        If cmbSubjectView.SelectedItem Is Nothing Then
    ...
    Private Sub GenerateStudentReport()
        Try
            ...
            ' If DataGridView has no data, try to load it
    ...
    Private Sub GenerateEnrollmentSummaryReport()
        Try
            ...
            ' Create a copy of the DataTable for PDF generation (handle column name differences)
            ...
            For Each row As DataRow In dt.Rows
                ' Skip total row if present (for "All Enrollments")
    ...
    Private Sub GenerateSectionReport()
        Try
            ...
            ' Get data from Section DataGridView
    ...
    Private Sub GenerateSubjectReport()
        Try
            ...
            ' Get data from Subject DataGridView
