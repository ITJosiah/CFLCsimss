...
Partial Class AdminManageSections
    ...
    Private Sub InitializeComponent()
        ...
        Me.SecLearningMaterials.Width = 108
        '
        'SecTeacherID
        '
