...
Public Class SuperAdminConfiguration
    ...
    Private Sub SuperAdminConfiguration_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        AddHandler Me.VisibleChanged, AddressOf SuperAdminConfiguration_VisibleChanged
    End Sub
    ...
    Private Sub SuperAdminConfiguration_VisibleChanged(sender As Object, e As EventArgs) Handles MyBase.VisibleChanged
        If Me.Visible Then
